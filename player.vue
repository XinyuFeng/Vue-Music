  ...
  <div class="player" v-show="playlist.length>0">
        ...
        <div class="middle"
          ...
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" v-bind:class="cdCls">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right">
              <i @click="toggleFavoriteIcon(currentSong)" class="icon" :class="getFavoriteIcon(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img v-bind:class="cdCls" width="40" height="40" :src="currentSong.image">
        </div>
        <div class="text">
    ...
    <audio ref="audio" :src="currentSong.url" @error="error" @timeupdate="updateTime" @ended="end"></audio>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  import {getHighResUrl} from 'api/song'
  ...
  export default {
    ...
    methods: {
      ...
      _getHighresUrl() {
        getHighResUrl(this.currentSong.mid).then((res) => {
          if (res.code === ERR_OK) {
            const vkey = res.data.items[0].vkey
            console.log(this.currentSong)
            const url = `http://dl.stream.qqmusic.qq.com/C400${this.currentSong.mid}.m4a?vkey=${vkey}&guid=1482048173&uin=944738080`
            this.setHighResUrl(url)
            console.log(this.currentSong.highResUrl)
          }
        })
      },
      _getPosAndScale() {
